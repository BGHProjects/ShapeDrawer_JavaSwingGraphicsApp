...
public class VectorRectangle implements VectorShape {
    ...
    /**
     * Converts the VectorRectangle to its command equivalent
     * @return A string representation of the VectorRectangle
     */
    @Override
    public String toString() { return String.format("RECTANGLE %f %f %f %f", x1, y1, x2, y2); }

    /**
     * Given the parameters, resize the shape
     *
    ...
    /**
     * Given the current Dimension of the Canvas, returns a scaled Rectangle2D.Double
     *
    ...
    public Shape toShape(Dimension windowSize) {
        ...
        return (new Rectangle2D.Double(_x1, _y1, w, h));
    }
}
